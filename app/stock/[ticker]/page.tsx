...
// Csak compact outputsize-szal elérhető range-ek (Alpha Vantage free tier)
        ...
        <div className="flex h-screen overflow-hidden bg-tp-bg">
            ...
            <aside className="w-[272px] flex-shrink-0 border-r border-tp-border bg-tp-surf flex flex-col">
                ...
                <div className="px-5 py-5 border-b border-tp-border flex items-center gap-3">
                    <Link
                        href="/"
                        className="w-8 h-8 rounded-lg bg-tp-card border border-tp-border flex items-center justify-center text-tp-muted hover:text-tp-primary hover:border-tp-accent/40 transition-all"
                    >
                        ←
                    </Link>
            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                ...
                <header className="px-8 py-4 border-b border-tp-border bg-tp-surf flex items-center flex-shrink-0">
                    ...
                    <button
                        onClick={() => refresh()}
                        className="text-tp-muted hover:text-tp-sec text-sm transition-colors px-2"
                        title="Refresh"
                    >
                        ↻
                    </button>
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-6">
                    ...
                    <div className="flex gap-4">
                        {pLoading ? (
                            ...
                            <>
                                ...
                                <MetricCard
                                    label="EPS (TTM)"
                                    value={fundamentals?.eps != null ? `$${fmtNum(fundamentals.eps)}` : "N/A"}
                                />
                                <MetricCard
                                    label="Beta"
                                    value={fmtNum(fundamentals?.beta ?? null)}
                                />
                            </>
                        )}
                    </div>
                    ...
                    {fundamentals && (
                        <div className="bg-tp-card border border-tp-border rounded-2xl p-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-5 gap-x-8">
                                {[
